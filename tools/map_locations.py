"""Fixed station list for the shareable snow-likelihood map.

Elevation is what decides which panel a station appears in on the map
(`--sea-level-max-m`, default 200m, matches UK convention for what counts as
"lowland"): mountain/summit stations vs. sea-level/lowland stations.
"""
